  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <button
        ...
        className="w-full py-3 px-4 rounded-xl mb-6 bg-surface-elevated hover:bg-card-hover border border-border-bright text-text-primary font-semibold text-sm cursor-pointer flex items-center justify-center gap-2.5 transition-all shadow-sm hover:border-primary/40"
      >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Button
          ...
          variant="primary"
          size="lg"
          className="w-full font-bold text-base shadow-lg shadow-primary/25"
          loading={loading}
        >
          Daftar Sekarang
        </Button>
